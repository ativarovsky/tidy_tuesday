...
This dataset explores posit::conf talks in 2023 and 2024. Some questions to think about: - Which speakers gave talks both years? - Are there keywords that appear in track titles in both 2023 and 2024? - What is the average sentiment of descriptions in each track?
...
```{r}
ggsave("conf_words.png", plot = final_plot, 
